...
WORDS_TO_REMOVE = {
    ...
    # Temporal & Institutional Background Noise - based on histogram
    ...
    "חינוך", "החינוך", "מערכת", "המערכת", "פרופ", "ופרופ", "לשכת", "המדענית", "מדענית", "וד","הנוכחית", "בני", "בן", "יעל",
    "עצמית", "מטרות", "טל", "מבוססת", "ענת", "מידת", "התייחסות", "לאורך", "דרכי", "חוסר", "בעלי", "מתמקדמת", "בנוסף", 
    "ליאת", "דנה", "מירי", "אורלי", "אנשי", "לבדוק", "ברק", "מור", "הילה", "תמר", "נערך", "התמקד", "אודט", "לתת", "רותם", 
    "עדי", "שלהלן", "בלאו", "נוי", "לילך", "ענבל", "רות", "שירי", "פיש", "תמי", "שבין", "דוד", "שירה", "עדו", "ואסף", "אסף", "לביא",
    "גדעון", "יוסי", "הראל", "שרון", "נעמה", "יהודית", "שמיר", "זיו", "חן", "ברוך", "אורית", "הרשקוביץ"
...
BASE_PHRASE_CONSOLIDATION = {
    ...
    "אוריינות": "אוריינות_ דיגיטלית", "דיגיטלית": "אוריינות_דיגיטלית", "התלמידים": "תלמידים", "מרחוק": "למידה_מרחוק",
    "בחן": "מבחן", "במדינות": "מדינות", "בעולם": "במדינות", "הרגשית": "מעורבות_רגשית", "רגשית": "מעורבות רגשית",
    "מלחמת": "מלחמה", "המלחמה": "מלחמה", 
    "להכשרת": "הכשרה", "הכשרת": "הכשרה"
}
